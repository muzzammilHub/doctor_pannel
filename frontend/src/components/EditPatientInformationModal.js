  ...
  const handleChange = (e) => {
    ...
    const handleSave = async() => {
      ...
      try {
        ...
        const data1 = await axios.post("http://localhost:4000/api/v1/patient/register",formData,{
          headers:{
        ...
        const data2 = await axios.post(`http://localhost:4000/api/v1/appointment/${id}`, formData,{
          headers:{
            Authorization: `Bearer ${localStorage.getItem('authToken')}`
          }
        })
